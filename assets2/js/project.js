function projectRun() {
    ...
    function projectTitle() {
        ...
        projectName.forEach((e, i) => {
            projectName[i].innerHTML = `<span class='prSplit${i + 1}'>${document
                .querySelector(`.prText0${i + 1}`)
                .innerText.split("")
                .join(`</span><span class=prSplit${i + 1}>`)}</span>`;
        });
    ...
    // 미디어 쿼리
    const media1902 = window.matchMedia("(min-width: 1025px)");
        ...
        function projectCont() {
            ...
            gsap.timeline({
                ...
                .to(
                    ".button2",
                    {
                        y: `${document.querySelector(".project_textBox").offsetHeight - document.querySelector(".project_sideMenu button").offsetHeight}px`,
                        opacity: 1,
                        duration: 1,
                        ease: "power2.out",
                    },
                ...
                .to(
                    ".leftpd2",
                    {
                        y: `-${document.querySelector(".project_textBox").offsetHeight}`,
                        opacity: 1,
                        delay: 0.2,
                        duration: 1,
                        ease: "power2.out",
            ...
            gsap.timeline({
                ...
                .to(
                    ".button3",
                    {
                        y: `${(document.querySelector(".project_textBox").offsetHeight - document.querySelector(".project_sideMenu button").offsetHeight) * 2}px`,
                        opacity: 1,
                        duration: 1,
                        ease: "power2.out",
                    },
            ...
            gsap.timeline({
                ...
                .to(
                    ".button4",
                    {
                        y: `${(document.querySelector(".project_textBox").offsetHeight - document.querySelector(".project_sideMenu button").offsetHeight) * 3}px`,
                        opacity: 1,
                        duration: 1,
                        ease: "power2.out",
                    },
                ...
                .to(
                    ".leftpd4",
                    {
                        y: `-${document.querySelector(".project_textBox").offsetHeight * 2}`,
                        opacity: 1,
                        delay: -0.2,
                        duration: 1.5,
                        ease: "power2.out",
            ...
            gsap.timeline({
                ...
                .to(
                    ".button5",
                    {
                        y: `${(document.querySelector(".project_textBox").offsetHeight - document.querySelector(".project_sideMenu button").offsetHeight) * 4}px`,
                        opacity: 1,
                        duration: 1,
                        ease: "power2.out",
                    },
                ...
                .to(
                    ".leftpd5",
                    {
                        y: `-${document.querySelector(".project_textBox").offsetHeight * 4}`,
                        opacity: 1,
                        delay: -0.3,
                        duration: 1.5,
                        ease: "power2.out",
