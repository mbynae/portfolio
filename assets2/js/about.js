...
function aboutFadeIn1() {
  ...
  aText.forEach((e, i) => {
    aText[i].innerHTML = `<span class='abSplit${i + 1}'>${document
      .querySelector(`.aText0${i + 1}`)
      .innerText.split("")
      .join(`</span><span class=abSplit${i + 1}>`)}</span>`;
  });
  const nonempasis = [];
  const emphasis = [...document.querySelectorAll(".abSplit6")].filter(
    (e, i) => {
      if (i >= 8 && i <= 13) {
...
function aboutFadeIn2() {
  ...
  t2.to(".bold-1", { y: "42.4805vw", x: "7.8125vw" }, "abText1")
    .to(
      ".bold-2",
      { y: "35.5469vw", x: "62.0117vw", color: "#14CF93" },
      "abText1"
    )
    .to(".about_textBox figure", { x: "-23.4375vw" }, "abText1")
...
function aboutFadeIn3() {
  ...
  t2.to(".bold-1", { y: "30.5990vw", x: "5.2083vw" }, "abText1")
    .to(
      ".bold-2",
      { y: "22.6563vw", x: "66.4063vw", color: "#14CF93" },
      "abText1"
    )
    .to(".about_textBox figure", { y: "-16.9271vw", x: "-29vw" }, "abText1")
