function titleText(){
    ...
    .to(".split1", {color: "#14CF93", stagger: 0.08, duration: 0.6}, "title2")
    .to(".split3", {color: "#14CF93", stagger: 0.08, duration: 0.6},"title2")
    .to(".split1", {color: "#383838", stagger: 0.14, duration: 0.6, delay: -1.1}, "title3")
    .to(".split3", {color: "#383838", stagger: 0.14, duration: 0.6, delay: -1.1}, "title3")
    .to(".split2", {duration: 0.9, x: 0, y: 0, rotation: 0, scale: 1, stagger: 0.02, opacity: 1, ease: Circ.easeOut})
